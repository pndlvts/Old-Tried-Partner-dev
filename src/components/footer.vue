...
export default {
  ...
  methods: {
      drop: function(event){
          ...
          let dataDrop = event.target.dataset.drop;
          let dataList = document.querySelector("div[data-list='" + dataDrop + "']");
          drop.classList.toggle("footer__title-drop_active");
          dataList.classList.toggle("footer__dropdown_active")
      }
  }
}
</script>